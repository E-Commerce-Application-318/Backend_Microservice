...
public class AgentConfig {
    ...
    {
        // 1. craete an in-memory embedding store
        EmbeddingStore<TextSegment> embeddingStore = new InMemoryEmbeddingStore<>();

        // 2. load document ("rules.txt") from the classpath
        Resource resource = resourceLoader.getResource("classpath:rules.txt");
        ...
        // 4. convert the segments into embeddings
        // 5. store the embeddings in the embedding store
